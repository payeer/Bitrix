...
$MESS["PAYEER_LOG"] = "Журнал";
$MESS["PAYEER_LOG_DESCR"] = 'Журнал запросов от Payeer сохраняется в файле: /payment/payeer/payeer_order.log <br/> Y - Включить, N - Выключить';
...
$MESS["PAYEER_MAIN_DESCR"] = "Payeer® Merchant позволяет принимать платежи всеми возможными способами по всему миру! Payeer® включает наиболее широкое покрытие по странам и типам операций, что позволяет увеличить оборот вашего сайта до 60% и больше процентов.";
